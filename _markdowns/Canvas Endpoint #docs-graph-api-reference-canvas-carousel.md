Graph API Reference v18.0: Canvas Carousel
...
On This PageCanvas CarouselReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Canvas Carousel
===============
...
curl -G \
 ...
 https://graph.facebook.com/v2.11/<CANVAS\_CAROUSEL\_ID>
```
### Parameters
...
You can't perform this operation on this endpoint.On This PageCanvas CarouselReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
