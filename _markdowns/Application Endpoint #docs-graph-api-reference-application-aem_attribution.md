Graph API Reference v18.0: Application Aem Attribution
...
On This PageApplication Aem AttributionReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Application Aem Attribution
===========================
...
```
GET /v18.0/{application-id}/aem\_attribution HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{application-id}/aem\_attribution',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/aem\_attribution"
 parameters:params
 HTTPMethod:@"GET"];
...
A list of AEMAttribution nodes.#### `paging`
...
You can't perform this operation on this endpoint.On This PageApplication Aem AttributionReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
