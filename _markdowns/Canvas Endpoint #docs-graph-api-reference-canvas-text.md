Graph API Reference v18.0: Canvas Text
...
On This PageCanvas TextReadingExampleParametersFieldsError CodesCreatingDeletingParametersReturn TypeError CodesGraph API Versionv18.0Canvas Text
===========
...
curl -G \
 ...
 https://graph.facebook.com/v2.11/<CANVAS\_TEXT\_ID>
```
### Parameters
...
On This PageCanvas TextReadingExampleParametersFieldsError CodesCreatingDeletingParametersReturn TypeError CodesFollow Us* 
#### Products
