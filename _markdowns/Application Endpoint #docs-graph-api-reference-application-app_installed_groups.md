Graph API Reference v18.0: Application App Installed Groups
...
On This PageApplication App Installed GroupsReadingFeature PermissionsExampleRequirementsParametersFieldsError CodesCreatingGraph API Versionv18.0Application App Installed Groups
================================
...
```
GET /v18.0/{application-id}/app\_installed\_groups HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{application-id}/app\_installed\_groups',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/app\_installed\_groups"
 parameters:params
 HTTPMethod:@"GET"];
...
| --- | --- |
| App Review | Your app must be approved for the Groups API feature. |
| App Installation | The app must be installed on the Group. |
| Tokens | An AppToken access token. See App Access Tokens. |
...
| --- | --- |
| `group_id`group\_id ID | Id of the group to check if app is installed in it or not
 |
...
You can't perform this operation on this endpoint.On This PageApplication App Installed GroupsReadingFeature PermissionsExampleRequirementsParametersFieldsError CodesCreatingFollow Us* 
#### Products
