Graph API Reference v18.0: Application Mobile Sdk Gk
...
On This PageApplication Mobile Sdk GkReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Application Mobile Sdk Gk
=========================
...
```
GET /v18.0/{application-id}/mobile\_sdk\_gk HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{application-id}/mobile\_sdk\_gk',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/mobile\_sdk\_gk"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageApplication Mobile Sdk GkReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
