...
` https://api.twitter.com/2/tweets/:id/liking_users `
  ...
  ` id `\                 string                  Tweet ID of the Tweet
  [Required]{.small}                              to request liking users
                                                  of.
  ----------------------- ----------------------- -----------------------
  ...
  [Optional]{.small}      ` author_id ` ,            to select which specific [Tweet
                          ...
                          ` entities ` , ` geo ` ,   fields. The Tweet fields will only return if the user has a pinned
                          ` id ` ,                   Tweet and if you\'ve also included the
                          ` in_reply_to_user_id ` ,  ` expansions=pinned_tweet_id ` query parameter in your request.
                          ` lang ` ,                 While the referenced Tweet ID will be located in the original
                          ` non_public_metrics ` ,   Tweet object, you will find this ID and all additional Tweet
                          ` public_metrics ` ,       fields in the ` includes ` data object.
                          ` organic_metrics ` ,      
                          ` promoted_metrics ` ,     
                          ` possibly_sensitive ` ,   
                          ` referenced_tweets ` ,    
