Graph API Reference v18.0: User Picture
...
On This PageUser PictureReadingRequirementsNotesLimitationsExampleParametersFieldsError CodesCreatingGraph API Versionv18.0User Picture
============
...
| Type | Requirement |
| --- | --- |
| Access Tokens | If querying an App-Scoped User ID:* None
...
You can't perform this operation on this endpoint.On This PageUser PictureReadingRequirementsNotesLimitationsExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
