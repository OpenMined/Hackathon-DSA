Graph API Reference v18.0: Application Cloudbridge Settings
...
On This PageApplication Cloudbridge SettingsReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Application Cloudbridge Settings
================================
...
```
GET /v18.0/{application-id}/cloudbridge\_settings HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{application-id}/cloudbridge\_settings',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/cloudbridge\_settings"
 parameters:params
 HTTPMethod:@"GET"];
...
A list of CloudbridgeSetting nodes.#### `paging`
...
You can't perform this operation on this endpoint.On This PageApplication Cloudbridge SettingsReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
