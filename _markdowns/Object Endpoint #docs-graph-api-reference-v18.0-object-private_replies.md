Object Private Replies - Graph API
...
On This Page/{object-id}/private\_repliesReadingDeletingUpdatingGraph API Versionv18.0`/{object-id}/private_replies`
==============================
...
```
POST /v18.0/{object-id}/private\_replies HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{object-id}/private\_replies"
 parameters:params
 HTTPMethod:@"POST"];
...
On This Page/{object-id}/private\_repliesReadingDeletingUpdatingFollow Us* 
#### Products
