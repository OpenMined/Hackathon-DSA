...
curl -X GET \
  'https://graph.facebook.com/v18.0/17895695668004550?fields=id,media_type,media_url,owner,timestamp&access_token=IGQVJ...'
```
#### Response
...
curl -i -X POST \
 "https://graph.facebook.com/v18.0/17918920912340654?comment_enabled=true&access_token=EAAOc..."
```
#### Response
