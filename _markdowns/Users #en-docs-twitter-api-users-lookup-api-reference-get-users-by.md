...
` https://api.twitter.com/2/users/by `
  ...
  ` usernames `\          string                     A comma separated list of Twitter usernames (handles). Up to 100
  [Required]{.small}                                 are allowed in a single request. Make sure to not include a space
