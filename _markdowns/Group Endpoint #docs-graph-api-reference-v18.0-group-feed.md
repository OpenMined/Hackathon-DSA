...
On This PageGroup FeedReadingRequirementsNotesPublishingRequirementsFieldsResponseUpdatingGraph API Versionv18.0Group Feed
==========
...
| Type of Requirement | Description |
| --- | --- |
| App Review | Your app must be approved for the following login permissions and features: (Click to expand) |
...
On This PageGroup FeedReadingRequirementsNotesPublishingRequirementsFieldsResponseUpdatingFollow Us* 
#### Products
