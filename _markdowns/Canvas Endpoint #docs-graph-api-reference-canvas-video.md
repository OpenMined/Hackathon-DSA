Graph API Reference v18.0: Canvas Video
...
On This PageCanvas VideoReadingExampleParametersFieldsError CodesCreatingDeletingParametersReturn TypeError CodesGraph API Versionv18.0Canvas Video
============
...
curl -G \
 ...
 https://graph.facebook.com/v2.11/<CANVAS\_VIDEO\_ID>
```
### Parameters
...
On This PageCanvas VideoReadingExampleParametersFieldsError CodesCreatingDeletingParametersReturn TypeError CodesFollow Us* 
#### Products
