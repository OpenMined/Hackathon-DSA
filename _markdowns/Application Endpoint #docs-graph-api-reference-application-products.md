Graph API Reference v18.0: Application Products
...
On This PageApplication ProductsReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Application Products
====================
...
| --- | --- |
| `product_ids`list<string> | List of product ids (e.g. 'golden\_gem') to retrieve info about
 |
...
A list of GamesIAPProduct nodes.#### `paging`
...
You can't perform this operation on this endpoint.On This PageApplication ProductsReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
