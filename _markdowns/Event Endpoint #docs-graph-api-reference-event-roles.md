Graph API Reference v18.0: Event Roles
...
On This PageEvent RolesReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Event Roles
===========
...
| Field | Description |
| --- | --- |
| `role_type`enum | The type of the role of the profile on the event
Default |
...
You can't perform this operation on this endpoint.On This PageEvent RolesReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
