Graph API Reference v18.0: Application Subscribed Domains
...
On This PageApplication Subscribed DomainsReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Application Subscribed Domains
==============================
...
```
GET /v18.0/{application-id}/subscribed\_domains HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{application-id}/subscribed\_domains',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/subscribed\_domains"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageApplication Subscribed DomainsReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
