/user/payment\_transactions - Graph API
...
On This Page/{user-id}/payment\_transactionsReadingPermissionsFieldsPublishingDeletingUpdatingGraph API Versionv18.0`/{user-id}``/payment_transactions`
===================================
...
```
GET /v18.0/me/payment\_transactions HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/me/payment\_transactions"
 parameters:params
 HTTPMethod:@"GET"];
...
On This Page/{user-id}/payment\_transactionsReadingPermissionsFieldsPublishingDeletingUpdatingFollow Us* 
#### Products
