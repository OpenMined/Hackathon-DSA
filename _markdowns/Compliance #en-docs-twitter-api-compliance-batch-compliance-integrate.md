...
You can then upload your Tweet or User IDs to this location by following step two onwards, from the quick start guide.
...
Visit the API reference page to customize your request
