...
On This Page/{object-id}/sharedpostsReadingPublishingDeletingGraph API Versionv18.0`/{object-id}/sharedposts`
==========================
...
| Name | Description |
| --- | --- |
| Page Public Content Access | This is a required feature permission. |
...
On This Page/{object-id}/sharedpostsReadingPublishingDeletingFollow Us* 
#### Products
