Graph API Reference v18.0: User Assigned Product Catalogs
...
On This PageUser Assigned Product CatalogsReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0User Assigned Product Catalogs
==============================
...
```
GET /v18.0/{user-id}/assigned\_product\_catalogs HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{user-id}/assigned\_product\_catalogs',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{user-id}/assigned\_product\_catalogs"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageUser Assigned Product CatalogsReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
