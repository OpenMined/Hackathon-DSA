Upload Service Provisioning API
...
On This PageApplication UploadsReadingCreatingRequirementsParametersReturn TypeError CodesUpdatingGraph API Versionv18.0Application Uploads
===================
...
| Type | Description |
| --- | --- |
| Access Tokens | User or System User. The app user who granted the token must have an Administrator or Developer role on the app. |
| Permissions | None. |
...
You can't perform this operation on this endpoint.On This PageApplication UploadsReadingCreatingRequirementsParametersReturn TypeError CodesUpdatingFollow Us* 
#### Products
