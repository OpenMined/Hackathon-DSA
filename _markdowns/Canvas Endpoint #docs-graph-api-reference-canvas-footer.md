Graph API Reference v18.0: Canvas Footer
...
On This PageCanvas FooterReadingExampleParametersFieldsError CodesCreatingDeletingParametersReturn TypeError CodesGraph API Versionv18.0Canvas Footer
=============
...
curl -G \
 ...
 https://graph.facebook.com/v2.11/<CANVAS\_FOOTER\_ID>
```
### Parameters
...
On This PageCanvas FooterReadingExampleParametersFieldsError CodesCreatingDeletingParametersReturn TypeError CodesFollow Us* 
#### Products
