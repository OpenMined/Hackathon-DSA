Graph API Reference v18.0: Application Model Asset
...
On This PageApplication Model AssetReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Application Model Asset
=======================
...
```
GET /v18.0/{application-id}/model\_asset HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/model\_asset"
 parameters:params
 HTTPMethod:@"GET"];
...
A list of SDKMLModel nodes.#### `paging`
...
You can't perform this operation on this endpoint.On This PageApplication Model AssetReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
