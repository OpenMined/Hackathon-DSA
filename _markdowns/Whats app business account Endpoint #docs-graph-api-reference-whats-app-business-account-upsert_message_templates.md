Graph API Reference v18.0: Whats App Business Account Upsert Message Templates
...
On This PageWhats App Business Account Upsert Message TemplatesReadingCreatingParametersReturn TypeUpdatingGraph API Versionv18.0Whats App Business Account Upsert Message Templates
===================================================
...
| `type`enum {OTP} | type
Required |
| `otp_type`enum {COPY\_CODE, ONE\_TAP} | Indicates button type. Set to COPY\_CODE if you want the template to use a copy code button, or ONE\_TAP to have it use a one-tap autofill button.
 |
...
You can't perform this operation on this endpoint.On This PageWhats App Business Account Upsert Message TemplatesReadingCreatingParametersReturn TypeUpdatingFollow Us* 
#### Products
