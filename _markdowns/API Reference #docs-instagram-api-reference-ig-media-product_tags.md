...
curl -i -X POST \
 "https://graph.facebook.com/v18.0/90010778325754/product_tags?updated_tags=%5B%0A%20%20%7B%0A%20%20%20%20product_id%3A'3859448974125379'%2C%0A%20%20%20%20x%3A%200.5%2C%0A%20%20%20%20y%3A%200.8%0A%20%20%7D%0A%5D&access_token=EAAOc..."
```
...
https://graph.facebook.com/v18.0/90010778325754/product_tags?updated_tags=[
  {
...
curl -i -X GET \
 "https://graph.facebook.com/v18.0/90010778325754/product_tags?access_token=EAAOc..."
```
#### Response
...
curl -i -X DELETE \
  "https://graph.facebook.com/v18.0/90010778325754/product_tags?deleted_tags=%5B%0A%20%20%7B%0A%20%20%20%20product_id%3A'3859448974125379'%2C%0A%20%20%20%20merchant_id%3A'90010177253934'%0A%20%20%7D%0A%5D&access_token=EAAOc..."
```
For reference, here is the HTML-decoded POST payload string:
