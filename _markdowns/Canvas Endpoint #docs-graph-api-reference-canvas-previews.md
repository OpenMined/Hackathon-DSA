Graph API Reference v18.0: Canvas Previews
...
On This PageCanvas PreviewsReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Canvas Previews
===============
...
| --- | --- |
| `user_ids`list<int> | SELF\_EXPLANATORY
 |
...
A list of TextWithEntities nodes.#### `paging`
...
You can't perform this operation on this endpoint.On This PageCanvas PreviewsReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
