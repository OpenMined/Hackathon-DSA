Graph API Reference v18.0: User Ids For Business
...
On This PageUser Ids For BusinessReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0User Ids For Business
=====================
...
```
GET /v18.0/{user-id}/ids\_for\_business HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{user-id}/ids\_for\_business"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageUser Ids For BusinessReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
