Graph API Reference v18.0: Whats App Business Account Subscribed Apps
...
On This PageWhats App Business Account Subscribed AppsReadingExampleParametersFieldsError CodesCreatingParametersReturn TypeError CodesUpdatingDeletingParametersReturn TypeError CodesGraph API Versionv18.0Whats App Business Account Subscribed Apps
==========================================
...
```
GET /v18.0/{whats-app-business-account-id}/subscribed\_apps HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{whats-app-business-account-id}/subscribed\_apps',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{whats-app-business-account-id}/subscribed\_apps"
 parameters:params
 HTTPMethod:@"GET"];
...
On This PageWhats App Business Account Subscribed AppsReadingExampleParametersFieldsError CodesCreatingParametersReturn TypeError CodesUpdatingDeletingParametersReturn TypeError CodesFollow Us* 
#### Products
