...
On This Page/{user-id}/scoresReadingPermissionsFieldsPublishingPermissionsFieldsResponseDeletingPermissionsFieldsResponseUpdatingGraph API Versionv18.0As of April 4, 2018, this endpoint only returns an empty data set. Please see the changelog for more information.
...
On This Page/{user-id}/scoresReadingPermissionsFieldsPublishingPermissionsFieldsResponseDeletingPermissionsFieldsResponseUpdatingFollow Us* 
#### Products
