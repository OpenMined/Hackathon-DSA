...
| `has_whatsapp_business_number`bool | Indicates whether WhatsApp number connected to this page is a WhatsApp business number. Can be read with Page Public Content Access or Page Public Metadata Access.
 |
| `has_whatsapp_enterprise_number_using_cloud_api`bool | Indicates whether WhatsApp number connected to this page is an enterprise number with Cloud API use. Can be read with Page Public Content Access or Page Public Metadata Access.
 |
