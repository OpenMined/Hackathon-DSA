Graph API Reference v18.0: Application Aem Conversion Configs
...
On This PageApplication Aem Conversion ConfigsReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Application Aem Conversion Configs
==================================
...
```
GET /v18.0/{application-id}/aem\_conversion\_configs HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{application-id}/aem\_conversion\_configs',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/aem\_conversion\_configs"
 parameters:params
 HTTPMethod:@"GET"];
...
A list of AEMConversionConfig nodes.#### `paging`
...
You can't perform this operation on this endpoint.On This PageApplication Aem Conversion ConfigsReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
