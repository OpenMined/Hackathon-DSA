Graph API Reference v18.0: Application Ad Placement Groups
...
On This PageApplication Ad Placement GroupsReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Application Ad Placement Groups
===============================
...
```
GET /v18.0/{application-id}/ad\_placement\_groups HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{application-id}/ad\_placement\_groups',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/ad\_placement\_groups"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageApplication Ad Placement GroupsReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
