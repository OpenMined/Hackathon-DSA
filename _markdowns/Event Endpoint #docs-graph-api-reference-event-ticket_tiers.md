Graph API Reference v18.0: Event Ticket Tiers
...
On This PageEvent Ticket TiersReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Event Ticket Tiers
==================
...
```
GET /v18.0/{event-id}/ticket\_tiers HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{event-id}/ticket\_tiers"
 parameters:params
 HTTPMethod:@"GET"];
...
A list of EventTicketTier nodes.#### `paging`
...
You can't perform this operation on this endpoint.On This PageEvent Ticket TiersReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
