Graph API Reference v18.0: Live Video Blocked Users
...
On This PageLive Video Blocked UsersReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Live Video Blocked Users
========================
...
```
GET /v18.0/{live-video-id}/blocked\_users HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{live-video-id}/blocked\_users"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageLive Video Blocked UsersReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
