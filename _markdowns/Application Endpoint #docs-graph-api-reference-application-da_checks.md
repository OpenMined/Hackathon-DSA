Graph API Reference v18.0: Application Da Checks
...
On This PageApplication Da ChecksReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Application Da Checks
=====================
...
```
GET /v18.0/{application-id}/da\_checks HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/da\_checks"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageApplication Da ChecksReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
