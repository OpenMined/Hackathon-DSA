Graph API Reference v18.0: User Ids For Apps
...
On This PageUser Ids For AppsReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0User Ids For Apps
=================
...
```
GET /v18.0/{user-id}/ids\_for\_apps HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{user-id}/ids\_for\_apps"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageUser Ids For AppsReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
