Graph API Reference v18.0: User Ids For Pages
...
On This PageUser Ids For PagesReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0User Ids For Pages
==================
...
```
GET /v18.0/{user-id}/ids\_for\_pages HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{user-id}/ids\_for\_pages"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageUser Ids For PagesReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
