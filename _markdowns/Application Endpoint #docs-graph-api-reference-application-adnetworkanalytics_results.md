Graph API Reference v18.0: Application Adnetworkanalytics Results
...
On This PageApplication Adnetworkanalytics ResultsReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0Application Adnetworkanalytics Results
======================================
...
```
GET /v18.0/{application-id}/adnetworkanalytics\_results HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{application-id}/adnetworkanalytics\_results',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/adnetworkanalytics\_results"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageApplication Adnetworkanalytics ResultsReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
