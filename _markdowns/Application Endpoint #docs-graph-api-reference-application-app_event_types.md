...
On This PageApp Event Types for an AppReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0App Event Types for an App
...
```
GET /v18.0/{application-id}/app\_event\_types HTTP/1.1
...
try {
 ...
 $response = $fb->get(
 '/{application-id}/app\_event\_types',
 '{access-token}'
 );
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{application-id}/app\_event\_types"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageApp Event Types for an AppReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
