Graph API Reference v18.0: User Business Users
...
On This PageUser Business UsersReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0User Business Users
===================
...
```
GET /v18.0/{user-id}/business\_users HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{user-id}/business\_users"
 parameters:params
 HTTPMethod:@"GET"];
...
A list of BusinessUser nodes.#### `paging`
...
You can't perform this operation on this endpoint.On This PageUser Business UsersReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
