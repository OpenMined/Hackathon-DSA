Graph API Reference v18.0: User Assigned Pages
...
On This PageUser Assigned PagesReadingExampleParametersFieldsError CodesCreatingGraph API Versionv18.0User Assigned Pages
===================
...
```
GET /v18.0/{user-id}/assigned\_pages HTTP/1.1
...
FBSDKGraphRequest \*request = [[FBSDKGraphRequest alloc]
 initWithGraphPath:@"/{user-id}/assigned\_pages"
 parameters:params
 HTTPMethod:@"GET"];
...
You can't perform this operation on this endpoint.On This PageUser Assigned PagesReadingExampleParametersFieldsError CodesCreatingFollow Us* 
#### Products
