...
| `languages`<br><br>array<string> | Search for ads based on the language(s) contained in the ad. Language codes are based on the [ISO 639-1 language codes](https://l.facebook.com/l.php?u=https%3A%2F%2Fwww.iso.org%2Fstandard%2F22109.html&h=AT0ZPt-so-smiatVFkvRGSA6gKABzfZqpqiuBtsv0UTQbkF7AGrk5bQYZ5F-suzTdLKVck4xXjshrU6xSdmySDL7A9EWn6iaMUQ7MzDMCpSZ72zAknbf-R2S74Ui5K-h63LFF3pgE2O9E2Fkp2CC) and also includes ISO 639-3 language codes CMN and YUE.For instance `?languages=['es', 'en']`. |
...
| `ad_creation_time`<br><br>string | The [UTC](https://l.facebook.com/l.php?u=https%3A%2F%2Fwww.timeanddate.com%2Ftime%2Faboututc.html&h=AT0S-XmCRP6wGszBoiqomt0AQUC1j-K4BhVzB2phOB7A0R5kKMt0sSf_0CH9H-eZBFkZRn8WosiqmYgR8W6Hliwsq62FqBcJXJSiwNI3odWWOwHRdZJoFPMiwVUYYjGDI74SKFgb9F74IPFcHaBv) date and time when someone created the ad. This is not the same time as when the ad ran. Includes date and time separated by `T`. Example: `2019-01-24T19:02:04+0000`, where `+0000` is the UTC offset. |
...
| `ad_delivery_start_time`<br><br>string | Date and time when an advertiser wants to start delivering an ad. Provided in [UTC](https://l.facebook.com/l.php?u=https%3A%2F%2Fwww.timeanddate.com%2Ftime%2Faboututc.html&h=AT0S-XmCRP6wGszBoiqomt0AQUC1j-K4BhVzB2phOB7A0R5kKMt0sSf_0CH9H-eZBFkZRn8WosiqmYgR8W6Hliwsq62FqBcJXJSiwNI3odWWOwHRdZJoFPMiwVUYYjGDI74SKFgb9F74IPFcHaBv) as in `ad_creation_time`.<br><br>Default<br><br>This field is default. |
