...
try {  
    SingleTweetLookupResponse result = apiInstance.tweets().findTweetById(ids);
...
try {  
    SingleTweetLookupResponse result = apiInstance.tweets().findTweetById(ids, expansions, null, null, mediaFields, null, null);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling TweetsApi#findTweetById");
    System.err.println("Status code: " + e.getCode());
