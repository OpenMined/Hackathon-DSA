...
List lookup introduction | Docs | Twitter Developer Platform 
...
You can use OAuth 1.0a User Context, App only, or OAuth 2.0 Authorization Code with PKCE to authenticate your requests to these endpoints. 
