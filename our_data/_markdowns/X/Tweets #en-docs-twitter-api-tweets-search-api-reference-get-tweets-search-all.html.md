...
GET /2/tweets/search/all | Docs | Twitter Developer Platform 
...
| Rate limit | App rate limit (Application-only): 300 requests per 15-minute window shared among all users of your appApp rate limit (Application-only): 1 per second shared among all users of your app |
### Query parameters
