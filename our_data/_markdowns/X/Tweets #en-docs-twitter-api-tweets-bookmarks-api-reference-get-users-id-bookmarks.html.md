...
| --- | --- | --- |
| `id` Required  | string | User ID of an authenticated user to request bookmarked Tweets for. |
...
try {
    GenericTweetsTimelineResponse result = apiInstance.bookmarks().getUsersIdBookmarks(id, null, null, null, null, null, null, null, null);
...
// For full list of params visit - https://github.com/twitterdev/twitter-api-java-sdk/blob/main/docs/BookmarksApi.md#getUsersIdBookmarks
//User ID
String id = "2244994945";
...
try {
    GenericTweetsTimelineResponse result = apiInstance.bookmarks().getUsersIdBookmarks(id, maxResults, null, expansions, null, null, mediaFields, null, null);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling BookmarksApi#getUsersIdBookmarks");
    System.err.println("Status code: " + e.getCode());
