...
Search Tweets - How to build a query | Docs | Twitter Developer Platform 
...
Here is an example of what this might look like using a cURL command, with an additional tweet.fields and max\_results parameter included. If you would like to use this command, please make sure to replace $BEARER\_TOKEN with your own Bearer Token:
...
| retweets\_of: | Standalone | Essential | Matches Tweets that are Retweets of the specified user. The value can be either the username (excluding the @ character) or the user’s numeric user ID.
...
| in\_reply\_to\_tweet\_id: | Standalone | Essential | *Available alias:* in\_reply\_to\_status\_id:
Matches on replies to the specified Tweet. 
Example: in\_reply\_to\_tweet\_id:1539382664746020864  |
| retweets\_of\_tweet\_id: | Standalone | Essential | *Available alias:* retweets\_of\_status\_id:
...
| quotes\_of\_tweet\_id: | Standalone | Essential | *Available alias:*quotes\_of\_status\_id:
...
| context: | Standalone | Essential | Matches Tweets with a specific domain id/enitity id pair. To learn more about this operator, please visit our page on annotations.
...
| bounding\_box: | Standalone | Elevated | *Available alias:*geo\_bounding\_box:
...
| has:media | Conjunction required | Essential | *Available alias:*has:media\_link
...
| has:video\_link | Conjunction required | Essential | *Available alias:*has:videos
