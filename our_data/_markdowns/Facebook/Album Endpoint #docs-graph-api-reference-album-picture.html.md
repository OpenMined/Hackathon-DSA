Graph API Reference v19.0: Album Picture - Documentation - Meta for Developers
...
* Reference
Graph API Versionv19.0Album Picture
=============
Reading
-------
### Example
...
| `redirect`boolean | Default value: `true`By default the picture edge will return a picture instead of a JSON response. If you want the picture edge to return JSON that describes the image set `redirect=0` when you make the request.
 |
| `type`enum{thumbnail, small, album} | Default value: `album`The size of this picture. It can be one of the following values: thumbnail, small, album.
 |
### Fields
