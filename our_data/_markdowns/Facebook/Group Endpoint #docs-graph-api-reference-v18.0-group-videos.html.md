Videos - Graph API - Documentation - Meta for Developers
...
* Reference
This document refers to an outdated version of Graph API. Please use the latest version.Graph API Versionv18.0Group Videos
============
