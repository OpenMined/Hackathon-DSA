Graph API Reference v19.0: Offline Conversion Data Set Upload Pull Sessions - Documentation - Meta for Developers
...
* Reference
Graph API Versionv19.0Offline Conversion Data Set Upload Pull Sessions
================================================
Reading
-------
...
```
#### `data`
A list of PartnerIntegrationPullSession nodes.#### `paging`
